...
.PHONY: install azure-push azure-pull github-push github-pull jwk
.ONESHELL:
.DEFAULT:
	@:
...
install: install-man
	...
	@cp -v markdown.css themes.css merge_table mkimageindex qutopia recycle.jpg "${PREFIX}/share/autoreadme/"
